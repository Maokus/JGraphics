...
public class BarGraphOld extends Pane implements GraphicOld {
    ...
    BarGraphOld(double width, double height, double barWidth, ArrayList<Color> colors, ArrayList<Double> lengths){
        this(width,height, barWidth, height/3*2, colors, lengths);
    }

    BarGraphOld(double width, double height, double barWidth, double barHeight,
